  ...
  return (
    <div className="bg-white text-white fixed top-0 left-0 w-full shadow-lg flex flex-row justify-between">
      <div className="lg:mx-28 md:mx-20 sm:mx-10 mx-5 lg:p-5 md:p-5 p-3">
        <img  className="w-30 h-8 lg:w-70 lg:h-10 cursor-pointer sm:w-30 sm:h-10" src="/Images/lejhro_logo_blue.png" alt="Logo" />
      </div>
      ...
      <div className="">
      <img className="fixed bottom-3 right-3 w-10 h-10 rounded-full cursor-pointer" src="/Images/arrow.png" alt="arrow" onClick={scrollToTop}></img>
      </div>
