...
=======
              <img className="w-70 h-10 cursor-pointer sm:w-50 sm:h-8"src={`${process.env.PUBLIC_URL}/Images/lejhro_logo_blue.png`} alt="Img_logo"></img>
>>>>>>> 7a1a0473d71f78d441745f5ec68623b133b0196d
         </div>
